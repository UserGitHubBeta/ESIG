...
def sapin(nombre_fleche, longueur, angle, couleur_choisis): 
# création d'une boucle pour répéter la création de la flèche en fonction du nombre de flèche choisis
    left(90)
